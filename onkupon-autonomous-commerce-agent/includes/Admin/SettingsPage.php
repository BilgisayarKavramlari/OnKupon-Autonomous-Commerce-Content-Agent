...
class SettingsPage extends BasePage {
    public function render(): void {
        if ( isset( $_POST['onkupon_save'] ) && current_user_can( CapabilityManager::capability() ) ) {
            ...
            foreach ( [ 'safe_mode', 'schema_enabled', 'learning_enabled', 'review_requests_enabled', 'auto_publish_verified_reviews', 'use_first_product_image_as_featured', 'use_category_fallback_image', 'x_allow_url_posts', 'x_text_only_mode', 'comparison_table_enabled', 'viral_title_enabled', 'allow_create_categories' ] as $flag ) {
