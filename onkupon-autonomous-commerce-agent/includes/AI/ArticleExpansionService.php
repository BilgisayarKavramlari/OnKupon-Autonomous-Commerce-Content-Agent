    ...
    public function expand( array $article, array $diagnostics = [] ): array {
        ...
        $prompt = [
            ...
            'requirements' => [
                ...
                'Total article body must be at least ' . max( 100, absint( $settings['min_article_words'] ?? 600 ) ) . ' words.',
                'Target ' . max( 100, absint( $settings['target_article_words'] ?? 900 ) ) . ' words and do not compress the article.',
                'Include at least 5 substantial sections; each section body should be 100-150 words.',
                'FAQ answers should be 50-80 words each.',
            ...
            'target_article_words' => absint( $settings['target_article_words'] ?? 900 ),
